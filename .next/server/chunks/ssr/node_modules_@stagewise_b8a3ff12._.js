...
"[project]/node_modules/@stagewise/toolbar/dist/index.es.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var define_MAIN_MODULES_default = {
    "panel-C1evgHYw.js": `import { jsx, jsxs } from "react/jsx-runtime";
...
function initToolbar(config = {}) {
    if (!(typeof window < "u")) {
        console.warn("Stagewise Toolbar is not supported in non-browser environments.");
        return;
    }
    ...
    iframe.style.display = "block", iframe.style.border = "none", iframe.style.overflow = "hidden", iframe.style.margin = "0", iframe.style.padding = "0", iframe.style.width = "100vw", iframe.style.height = "100vh", iframe.style.backgroundColor = "transparent", iframe.style.pointerEvents = "none", iframe.style.colorScheme = "normal", iframe.sandbox.add("allow-same-origin"), iframe.sandbox.add("allow-scripts"), iframe.sandbox.add("allow-presentation"), iframe.sandbox.add("allow-pointer-lock"), iframe.setAttribute("allowtransparency", "true"), iframe.srcdoc = '<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="preconnect" href="https://rsms.me/"><link rel="stylesheet" href="https://rsms.me/inter/inter.css"></head><body style="pointer-events: none;"></body></html>', iframe.addEventListener("load", ()=>{
        ...
        const handleMouseMove = (e)=>{
            const elementAtPoint = iframe.contentDocument.elementFromPoint(e.clientX, e.clientY), isInteractive = elementAtPoint && elementAtPoint !== document.body && elementAtPoint.tagName !== "HTML";
        ...
        const devSuffix = "", main_modules = Object.fromEntries(Object.entries(define_MAIN_MODULES_default).map(([key, value])=>[
                key,
        ...
        if (main_modules["@stagewise/toolbar/plugin-ui"] = URL.createObjectURL(new Blob([
            "export * from 'plugin-ui.js'"
        ], {
            type: "text/javascript"
        })), config.plugins) for (const [index, plugin] of config.plugins.entries()){
            const plugin_module = URL.createObjectURL(new Blob([
                plugin.mainPlugin
            ], {
                type: "text/javascript"
            }));
        ...
        const config_module = URL.createObjectURL(new Blob([
            getConfigModuleContent(config)
        ], {
            type: "text/javascript"
        }));
...
`)) ?? "", convertedPluginArray = `[${((_b = config.plugins) == null ? void 0 : _b.map((_, index)=>`plugin${index}`).join(",")) ?? ""}]`, convertedConfig = {
    ...
    return configString = configString.replace('"__PLUGIN_PLACEHOLDER__"', convertedPluginArray), `${pluginImports}
...
"[project]/node_modules/@stagewise/toolbar-react/dist/index.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stagewise$2f$toolbar$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@stagewise/toolbar/dist/index.es.js [app-ssr] (ecmascript)");
...
function StagewiseToolbar({ config, enabled = ("TURBOPACK compile-time value", "development") === "development" }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stagewise$2f$toolbar$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initToolbar"])(config);
    }, [
        config,
        enabled
    ]);
...
//# sourceMappingURL=node_modules_%40stagewise_b8a3ff12._.js.map